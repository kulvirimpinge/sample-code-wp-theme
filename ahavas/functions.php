<?php
/**
 * Ahavas Chesed functions and definitions
 *
...
/**
 * Ahavas Chesed only works in WordPress 3.6 or later.
 */
...
function twentythirteen_scripts_styles() {
	...
	// Loads JavaScript file with functionality specific to Ahavas Chesed.
